...
export const SvgPhone = () => {
  return (
    <svg xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" className="mainmenu-icon mainmenu-icon-k122" width="19"  height="32" ><defs><symbol id="k122" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 32">
      ...
      </symbol></defs><use xlinkHref="#k122"></use>
    </svg>
  )
}
